      ...
      setApplications((prev) =>
        prev.map((app) =>
          app.id === application.id
            ? { ...app, attributes: { ...app.attributes, status: newStatus } }
            : app
        )
      );
      // Update status counts
      if (meta?.status_counts) {
        const oldStatus = application.attributes.status;
        setMeta({
          ...meta,
          status_counts: {
            ...meta.status_counts,
            [oldStatus]: Math.max(0, (meta.status_counts[oldStatus] || 0) - 1),
    ...
    <div className="flex flex-1 flex-col gap-6 p-4 pt-0">
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-bold">
            {career ? career.title : "Job Applications"}
          </h1>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {meta ? `${meta.total} total applications` : "View and manage applications"}
          </CardDescription>
        </CardHeader>
        <CardContent>
          <DataTable
            ...
            columns={columns}
            loading={false}
            emptyMessage="No applications found for this position"
